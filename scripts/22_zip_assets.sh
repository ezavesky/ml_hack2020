...
#rsync -aP --delete --exclude='.*' --exclude="*auth*.json" --exclude=packages $ROOT_DIR/cmlp/work/. $ROOT_DIR/notebooks/.
rsync -aP --delete --exclude='.*' --exclude="*auth*.json" --exclude='models/*' --exclude=packages $ROOT_DIR/cmlp/work/. $ROOT_DIR/notebooks/.
